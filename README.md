...
<table align="center" width="100%">
  ...
  <tr>
    ...
    <td width="50%" align="center">
      ...
      <br/>
      <em>Autogenerated OpenAPI documentation for <code>POST /predict</code> (with embedded SHAP attributions) and <code>GET /health</code> endpoints with strict Pydantic validation.</em>
    </td>
  </tr>
</table>
